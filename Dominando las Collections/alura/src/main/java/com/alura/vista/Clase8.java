...
public class Clase8 {
    ...
    public static void main(String[] args) {
        ...
        for (List<Integer> lista : listas) {
            ...
            //LINKEDLIST A <-> (B1) <-> B <-> C <-> D   quita relacion de una y adiciona otra
            //más eficiente para add para get menos eficiente
            
            //ARRAYLIST  A -> (B1) -> B -> C -> D    mueve todas las posiciones de la lista
        }
    }
}
